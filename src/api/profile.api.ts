...
const URL_GET_PROFILE = '/rest/v1/channels/me'
const URL_UPDATE_PROFILE = '/rest/v1/channels/updateMe'
export const URL_CHANGE_PASSWORD = '/rest/v1/channels/updateMyPassword'
const profileApi = {
  getProfile: () => {
